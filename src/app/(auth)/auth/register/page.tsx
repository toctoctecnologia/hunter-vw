        ...
        <div className="flex-1 flex items-center">
          <Card className="w-full shadow-none border-none bg-primary-foreground dark:bg-zinc-900">
            <CardHeader className="px-2 sm:px-4">
              <CardTitle className="text-2xl sm:text-3xl">Novo Cadastro</CardTitle>
              <CardDescription className="text-sm sm:text-base">
                Crie sua conta para acessar o Hunter CRM
              </CardDescription>
            </CardHeader>
            <CardContent className="px-2 sm:px-4">
              <RegisterForm inviteId={inviteId} inviteEmail={email} />
            </CardContent>
          </Card>
        </div>
      </div>
        ...
        <div className="relative z-10 flex w-full flex-col gap-6 p-10 sm:p-14">
          <div className="max-w-xl space-y-4">
            ...
            <h2 className="text-3xl font-semibold leading-tight sm:text-4xl lg:text-5xl">
              Resultados reais para imobiliárias modernas
            </h2>
            <p className="text-base text-slate-200/90 sm:text-lg">
              Automatize a sua operação comercial, transforme oportunidades em vendas e acompanhe sua carteira em tempo
              real com o Hunter.
            </p>
          </div>
