...
import { LeadsReportFilters, LeadFunnelStages } from '@/shared/types';
import { cn, leadFunnelStepToLabel } from '@/shared/lib/utils';
...
interface LeadReportFiltersSheetProps {
  open?: boolean;
  onClose?: () => void;
  onApplyFilters?: (filters: LeadsReportFilters) => void;
}

export default function LeadReportFiltersSheet({ open, onClose, onApplyFilters }: LeadReportFiltersSheetProps) {
  ...
  const onSubmit = (data: FilterFormData) => {
    onApplyFilters?.(data as LeadsReportFilters);
    onClose?.();
  };
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} value={field.value}>
                    ...
                    <SelectContent>
                      {Object.values(LeadFunnelStages).map((status) => (
                        <SelectItem key={status} value={status}>
                          {leadFunnelStepToLabel(status)}
                        </SelectItem>
                      ))}
                    </SelectContent>
                  </Select>
