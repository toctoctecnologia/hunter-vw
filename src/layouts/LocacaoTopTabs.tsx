...
const tabs: TabItem[] = [
  { 
    ...
    icon: Plus, 
    isPrimary: true,
    matchPaths: ['/gestao-locacao/contratos/novo']
  },
  { 
    id: 'padroes', 
    label: 'Padrão de contrato', 
    href: '/gestao-locacao/padroes-contrato', 
    icon: FileText,
    matchPaths: ['/gestao-locacao/padroes-contrato', '/gestao-locacao/padroes']
  },
  { 
    id: 'reajustes', 
    label: 'Reajustes', 
    href: '/gestao-locacao/reajustes', 
    icon: RefreshCw,
    matchPaths: ['/gestao-locacao/reajustes']
  },
  { 
    id: 'dimob', 
    label: 'DIMOB', 
    href: '/gestao-locacao/dimob', 
    icon: FileSpreadsheet,
    matchPaths: ['/gestao-locacao/dimob']
  },
  { 
    id: 'seguros', 
    label: 'Seguros', 
    href: '/gestao-locacao/seguros', 
    icon: Shield,
    matchPaths: ['/gestao-locacao/seguros']
  },
];

export function LocacaoTopTabs() {
